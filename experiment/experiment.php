    ...
    <div class="container my-3">
      <div class="row pt-2 pb-1">
          ...
          <div class="row mb-3">
              <div class="col-sm-3">
                  <div class="card">
                      <img src="foodpick.jpg" class="card-img-top" alt="Europe">
                      <div class="card-body">
              ...
              <div class="col-sm-3">
                  <div class="card">
                      <img src="foodpick.jpg" class="card-img-top" alt="London">
                      <div class="card-body">
              ...
              <div class="col-sm-3">
                  <div class="card">
                      <img src="foodpick.jpg" class="card-img-top" alt="New York">
                      <div class="card-body">
